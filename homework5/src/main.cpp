...
int main() {
    // Box
    filesystem::path inputDir("D:/learnOpengl/webopengl/games202/homework5/src/util/examples/box/input");
    filesystem::path outputDir("D:/learnOpengl/webopengl/games202/homework5/src/util/examples/box/output");
    int frameNum = 20;
